...
This project demonstrates the machine learning workflow, including:
...
The project uses common data science tools and libraries:
...
```bash
git clone https://github.com/comrade70/credit-risk-scoring-model.git
